...
<div class="container ">
    ...
    <div class="row">
        <div>
            <form action="<?php echo base_url() ?>vip/weekly_report" method="post">
                        ...
                        <tr>
                            <td>
                                <div class="row-left">
                                    ...
                                    <input type="text" value="<?php echo $from_date; ?>" id="txtFromDate"
                                        aria-describedby="emailHelp" name="from_date">
                                </div>
                                <div class="row-mid">
                                    <label for="exampleInputEmail1">To Date : </label>
                                    <input type="text" value="<?php echo $to_date; ?>" id="txtToDate"
                                        aria-describedby="emailHelp" name="to_date">
                                </div>
                                <div class="row-right">
            ...
            <div class="row">
                <div id="accordion">
                    ...
                    <div class="grid" id="dvPointReceived">
                    <form action="" method="post">
                    <table style="width:100%" id='employeeList'>
                            <thead>
                                <tr>
                    ...
                    <h3>Gaming Report</h3>
                    <div class="grid" id="dvGamingReport">
                    <form action="" method="post">
                    <table style="width:100%" id='employeeList'>
                            <thead>
                                <tr>
                    ...
                    <div class="grid" id="dvRevenueReport">
                    <form action="" method="post">
                    <table style="width:100%" id='employeeList'>
                            <thead>
                                <tr>
