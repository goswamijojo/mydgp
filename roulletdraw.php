                        ...
                        <td>
                            <div class="grid">
                                <table style="width:100%;">
                                    <thead>
                                        <tr>
                                            <th style="cursor:pointer" datatype="int" colname="SRNO" sortorder="desc">
                                                Sr. No.</th>
                                            <th style="cursor:pointer" datatype="" colname="DRAWNO" sortorder="asc">
                                                Winning No.</th>
                                            <th style="cursor:pointer" datatype="" colname="DRAW_TIME" sortorder="asc">
                                                Draw Time</th>
                                        </tr>
                                    </thead>
                                    <tbody id="tableData">
