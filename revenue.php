...
<body id="page1">
    ...
    <div class="gridContainer clearfix">
                                    ...
                                    <td>
                                        <div class="row-left">
                                            ...
                                            <input class="" data-val="true" data-val-required="Please Provide From Date"
                                                id="txtFromDate" name="strFromDate" readonly="True" type="text"
                                                value="" />
                                        </div>
                                        <div class="row-mid">
                                            <label for="strToDate">To Date : </label>
                                            <input class="" data-val="true" data-val-required="Please Provide To Date"
                                                id="txtToDate" name="strToDate" readonly="True" type="text" value="" />
                                        </div>
                                        <div class="row-right">
        ...
        <table style="width:100%;">
            <thead>
                <tr>
                <th datatype="int" colname="SRNO" sortorder="desc" style="cursor:pointer;">Sr. No.</th>
                <th datatype="" colname="F_DATE" sortorder="asc" style="cursor:pointer;">From Date</th>
                <th datatype="" colname="T_DATE" sortorder="asc" style="cursor:pointer;">To Date</th>
                <th datatype="" colname="NEWPROFIT" sortorder="asc" style="cursor:pointer;">Profit</th>
                <th datatype="" colname="ACTUAL_POINTS" sortorder="asc" style="cursor:pointer;">Actual Rev</th>
                <th datatype="" colname="REVENUE_DEDUCTED" sortorder="asc" style="cursor:pointer;">Rev Ded</th>
                <th datatype="" colname="DEDN_PERCENTAGE" sortorder="asc" style="cursor:pointer;">Ded %</th>
                <th datatype="" colname="POINT_TRANSFER" sortorder="asc" style="cursor:pointer;">Rev After Loan</th>
                <th datatype="" colname="REVENUE" sortorder="asc" style="cursor:pointer;">Revnue %</th>
                </tr>
            </thead>
            <tbody>
            <?php                
                ...
                <tr>
                    ...
                    <td align="center"><?php echo $interval['start_date']; ?></td>
                   
                    <td align="center"><?php echo $interval['end_date']; ?></td>

                    <?php

                     $bet = $interval['interval_bet_amount'] - $interval['interval_winning_amount'];

                    if($bet <= 0){
                        $bet_per = $interval['interval_bet_amount']*50/100;
                    ?>
                    <td align="center" style="color:black; cursor: pointer;"><?php echo  $interval['interval_bet_amount']; ?></td>
                    <td align="center"><?php echo  $bet_per ?></td>
                    <td align="center">0</td>
                    <td align="center">0</td>
                    <td align="center"><?php echo  $bet_per ?></td>
                    <td align="center" style="color:red">50%</td>
                   <?php
            }else{
                $winning_per = $interval['interval_winning_amount']*20/100;
                ?>
                <td align="center" style="color:red; cursor: pointer;"><?php echo - $interval['interval_winning_amount']; ?></td>
                <td align="center"><?php echo  $winning_per ?></td>
                    <td align="center">0</td>
                    <td align="center">0</td>
                    <td align="center"><?php echo  $winning_per ?></td>
                    <td align="center" style="color:red">20%</td>
                <?php
            }
                   ?>
...
<tbody>
  ...
  <input id="hdnMemberType" name="strMemberType" type="hidden" value="A" /></form>
