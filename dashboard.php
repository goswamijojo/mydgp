...
<div class="container">
    ...
    <div class="row">
        <div>
            ...
            <form action="<?php echo base_url() ?>vip/dashboard" method="post">
                            ...
                            <td>
                                <div class="row-left">
                                    ...
                                    <input class="" data-val="true" data-val-required="Please Provide From Date"
                                        id="txtFromDate" name="from_date" readonly="True" type="text"
                                        value="<?php echo $from_date; ?>">
                                </div>
                                <div class="row-mid">
                                    <label for="strToDate">To Date : </label>
                                    <input class="" data-val="true" type="text"
                                        data-val-required="Please Provide To Date" id="txtToDate" name="to_date"
                                        readonly="True" value="<?php echo $to_date; ?>">
                                </div>
                                <div class="row-mid">
                                    <label for="MemberID">Member ID : </label>
                                    <input class="" data-val="true"
                                        data-val-regex="The field Member ID  must match the regular expression &#39;^GK[0-9]{8}$&#39;."
                                        data-val-regex-pattern="^GK[0-9]{8}$" id="txtMemberID" name="member_id"
                                        type="text" value="<?php echo $member_id; ?>">
                                </div>
            ...
            <div class="row">
                <div id="accordion">
                    ...
                    <h3>Points Transferred But yet to be Received</h3>
                    ...
                    <h3>Points yet to be Received</h3>
                ...
                <input id="hdnFieldEnabledNarration" name="hdnFieldEnabledNarration" type="hidden" value="N" />
                </form>
